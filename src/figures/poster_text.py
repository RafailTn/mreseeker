...
METHODS = (
    ...
    "absent from both. External "
    "evaluation used the Hejret and Klimentova AGO2 datasets and SAEC cells "
    "(GSE304955). "
    ...
    "energy z-scores and hg38 470-way phastCons conservation yield 26 selected features. "
    "Of 25 AutoGluon candidates, CatBoost was chosen from the Pareto front of APS "
    ...
    "precision (APS) with 95% bootstrap intervals; exact TreeSHAP gives per-prediction "
    "explanations."
)

RESULTS = (
    "On the Manakov test and leftout sets both models outperform TargetScan (APS 0.77 "
    "and 0.76): the sequence CNN reaches 0.88 on both, and CatBoost 0.84 on both. "
